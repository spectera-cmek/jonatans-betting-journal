...
const BOOKMAKER_ALIASES: Record<string, string> = {
  b365: "Bet365",
  "888": "888sport",
  // "Happy" och "HappyCasino" är samma bok i loggen; kupongen skriver bara ut
  // det korta namnet ibland.
  happy: "HappyCasino",
  happybet: "HappyCasino",
  // Vera&John loggas som "veraochjohn" — behåll den stavningen som kanonisk.
  verajohn: "veraochjohn",
  veraandjohn: "veraochjohn",
};
